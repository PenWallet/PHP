...
class LibroModel implements JsonSerializable
{
    ...
    public function __construct($cod,$tit,$pag,$capsArray)
    {
        $this->codigo=$cod;
        $this->titulo=$tit;
        $this->numpag=$pag;
        $this->capsArray=$capsArray;
    }
    ...
    function jsonSerialize()
    {
        return array(
            ...
            'codigo' => $this->codigo,
            'numpag' => $this->numpag,
            'capsArray' => $this->capsArray
        );
    }

    public function __sleep(){
        return array('titulo' , 'codigo' , 'numpag' , 'capsArray');
    }
    ...
    /**
     * @param mixed $capsArray
     */
    public function setCapsArray($capsArray)
    {
        $this->capsArray = $capsArray;
    }
